...
// Create a logger instance (can be global or per-class)
...
class BookDataLoader {
  ...
  static Future<List<Book>> loadBooks() async {
    try {
      ...
      _logger.e('Error loading books: $e', error: e, stackTrace: stackTrace); // Use error level for errors
      // Return an empty list or rethrow the error as needed
      return [];
    }
  }

  // Optional: Get unique genres from a list of books
  static List<String> getUniqueGenres(List<Book> books) {
    final Set<String> genres = {}; // Use a Set to automatically handle uniqueness
